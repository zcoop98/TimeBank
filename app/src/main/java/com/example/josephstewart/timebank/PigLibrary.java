...
public class PigLibrary //storing class
{
    ...
    public final static int[] SILPIGS =
            {
                  //R.drawable.b_porky, //resource location for default pig.        //Unnecessary since default is never locked
                  //R.drawable.b_broken_pig, //resource location for broken pig.    //Unnecessary since broken pig won't be locked
